---
name: reviewer-ci-release
description: CI and release review for pipeline reliability, signal quality, and release hygiene.
trigger: TRIGGER when: changing workflows, checks, tags, or release automation. DO NOT TRIGGER when: request is unrelated to review policy.
---
...
## Domain Checklist
- Fast-fail signal quality and debuggability
- Workflow scope correctness and secret handling
- Release/tag/changelog consistency
