...
description: Security-focused review for auth, input handling, command/file/query safety, and secret hygiene.
trigger: TRIGGER when: changes touch user input, auth/authz, file operations, secrets, or external calls. DO NOT TRIGGER when: request is unrelated to review policy.
---
...
## Domain Checklist
- Injection, traversal, and unsafe command execution
- Authentication and authorization bypass risks
- Sensitive data exposure in logs, configs, or responses
