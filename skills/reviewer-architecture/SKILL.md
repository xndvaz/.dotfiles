...
description: Architecture review for boundaries, coupling, layering, and long-term evolution risk.
trigger: TRIGGER when: changes alter module boundaries, shared contracts, or core architecture. DO NOT TRIGGER when: request is unrelated to review policy.
---
...
- Coupling/cohesion impact on future change cost
- Migration path and rollback safety for structural changes
