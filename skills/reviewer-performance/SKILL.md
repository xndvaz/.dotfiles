...
description: Performance review for measurable latency, throughput, and resource regression risks.
trigger: TRIGGER when: hot paths, loops, data structures, or build/runtime costs may change. DO NOT TRIGGER when: request is unrelated to review policy.
---
...
## Domain Checklist
- Complexity and hotspot regression risk
- Resource usage (CPU, memory, I/O) tradeoffs
- Benchmark/test evidence for performance claims
